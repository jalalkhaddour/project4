<template lang="">
     <div v-if="editUser">
    <permission :userid="userid" :perms="perms" :userin="user" @close="close"  ></permission>
  </div>
  <div v-else>
    <div>
...
import permission from '../../components/AdministrationService/permission.vue';
...
export default {
  ...
  ,data () {
    ...
    async edit(user){
      ...
      try{
             const res = await axios.post('/getuserper',{
              id:this.userid,
