<template>
        ...
        <div id="al_baath_logo">
         ...
         <button ><img @click="menuTOG" class=" absolute top-0 right-0 h-12 w-12  me" src="../assets/Images/menu.png "  ></button>
          <div class="backdrop" @click="menu1=false" v-if="menu1">
           <div v-if="menu1" class="absolute top-1px right-0 text-white bg-primary text-lg w-20 text-center text-right rounded-lg m-2 mt-8 me" >
              
             <button class="hover:bg-hovercolor rounded-lg text-center w-20"> <router-link to="/" >  &nbsp; الرئيسية  &nbsp;</router-link><br></button>
               <hr class="bg-body" />
             <button class="hover:bg-hovercolor rounded-lg text-center w-20" > <router-link to="/administrtive"> &nbsp;إداري &nbsp;</router-link><br></button>
               <hr class="bg-body" />
             <button class="hover:bg-hovercolor rounded-lg text-center w-20"> <router-link to="/about">&nbsp;حول &nbsp;</router-link><br></button> 
                    
                   
           </div>
          </div>
        <div class="text-white   text-xl px-7 absolute top-0 right-3  flex  justify-between space-x-12 invisible md:visible ">
          
          <router-link to="/about" class="my-8 ">&nbsp;حول &nbsp;</router-link>
          <router-link to="/administrtive" class="my-8 " v-if="Role=='Admin' || Role=='AfAdmin' || Role=='ExAdmin'"> &nbsp;إداري &nbsp;</router-link>
          <router-link to="/" class="my-8 transition duration-500 hover:border-yellow-400 border-b-4 border-gray-800 border-opacity-75  ">  &nbsp; الرئيسية  &nbsp;</router-link>
  ...
  <div v-if="showa">
  <ChangePass   @close="close"></ChangePass></div>
