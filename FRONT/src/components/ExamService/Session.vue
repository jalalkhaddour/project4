        ...
        <table>
            ...
            <tbody>
                <tr v-if="showS">
                    <td>
                        <button
                            class="bg-primary text-body text-xl rounded-lg text-center my-1 py-2 px-4 hover:bg-hovercolor"
                            @click="edit(user)"
                        >
                            إدخال
                        </button>
                    ...
                    <td>
                        <input
                            type="text"
                            class="w-16 border-2 border-primary rounded-lg text-center"
                            v-model="check"
                        />
                    </td>
                    <td></td>
                    ...
                    <td>
                        <input
                            type="text"
                            class="w-32 border-2 border-primary rounded-lg text-center"
                            v-model="Wresult"
                        />
                    </td>
                    <td>
            ...
            try {
                const res = await axios.post(
                    "/getCheckSess",
                    {
                        ...
                        studyYear: this.selYear,
                        studysemster: this.semster,
                    },
                    {
                        headers: {
                            Authorization:
