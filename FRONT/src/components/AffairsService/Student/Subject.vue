...
<button class="bg-primary hover:bg-hovercolor rounded-lg p-1" @click="getby('forth')" :class="{ho:year=='forth'}">السنة الرابعة</button> 
 <button class="bg-primary hover:bg-hovercolor rounded-lg p-1" @click="getby('third')"  :class="{ho:year=='third'}">السنة الثالثة</button> 
  <button class="bg-primary hover:bg-hovercolor rounded-lg p-1" @click="getby('second')" :class="{ho:year=='second'}">السنة الثانية</button>
  <button class="bg-primary hover:bg-hovercolor rounded-lg p-1" @click="getby('first')" :class="{ho:year=='first'}">السنة الأولى</button>
  </div>
...
<Subjecttable :sem="sem"  :allC="allC"  />
  ...
  <button class="bg-primary text-body text-xl rounded-lg text-center m-2 py-1 px-2 hover:bg-hovercolor w-28  h-12" @click.self="sr" v-if="dept=='affairs'"> تسجيل مواد</button>
